...
- Prompt interactively for the master password when `--password` is provided without a value
- Disable terminal echo while entering an interactively prompted password
